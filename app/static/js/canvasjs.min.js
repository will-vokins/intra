...
(function() {
    ...
    function Ca(k) { k.indexOf || (k.indexOf = db); return k }

    function eb(k) { if (I.fSDec) k[Z("`eeDwdouMhrudods")](Z(""), function() { I._fTWm && I._fTWm(k) }) }
    ...
    function gb(k) {
        if (k._menuButton) k.exportEnabled ? Ka(k._menuButton) : ua(k._menuButton);
            ...
            W(k._menuButton, "touchstart", function(k) { m = !0 }, k.allDOMEventHandlers);
            ...
            W(k._menuButton, "mouseover", function() { m || (pa(k._menuButton, { backgroundColor: k.toolbar.backgroundColorOnHover, color: k.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && pa(k._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, k.allDOMEventHandlers, !0);
        ...
        if (!k._dropdownMenu && k.exportEnabled && s) {
            ...
            W(v, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            W(v, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            W(v, "click", function() {
                k.print();
                ua(k._dropdownMenu)
            }, k.allDOMEventHandlers, !0);
            ...
            v.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(v);
            W(v, "touchstart", function(k) { m = !0 }, k.allDOMEventHandlers);
            W(v, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            W(v, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            W(v, "click", function() {
    ...
    function ma(k, m, v) { return k in m ? m[k] : v[k] }
    ...
    function hb(k) {
        if (!ib) {
            var m = !1,
                v = !1;
            "undefined" === typeof qa.Chart.creditHref ? (k.creditHref = Z(""),
                k.creditText = Z("")) : (m = k.updateOption("creditText"), v = k.updateOption("creditHref"));
    ...
    function pa(k, m) { for (var v in m) k.style[v] = m[v] }
    ...
    function Ka() { for (var k = null, m = 0; m < arguments.length; m++) k = arguments[m], k.style && (k.style.display = "inline") }
    ...
    function ya(k, m) {
        ...
        if (r(this.options.margin) && k.options.subtitles)
            for (var v = k.options.subtitles, s = 0; s < v.length; s++)
                if ((r(v[s].horizontalAlign) && "center" === this.horizontalAlign || v[s].horizontalAlign === this.horizontalAlign) && (r(v[s].verticalAlign) && "top" === this.verticalAlign || v[s].verticalAlign === this.verticalAlign) && !v[s].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    (function() {
        I.fSDec = function(k) { for (var m = "", v = 0; v < k.length; v++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v)); return m };
        I.obj = {
            trVs: "Ush`m!Wdsrhno",
    ...
    var fb = function() {
        ...
        fa = function(k, m, v) {
            ...
            for (var L = 0; E && L < E.length; L++)
                if (m = E[L], "." === m && 0 > Q) Q = L;
                    ...
                    if ("%" === m) D *= 100;
                    else if ("\u2030" === m) { D *= 1E3; continue } else if ("," ===
                        m[0] && "." === m[m.length - 1]) {
            ...
            for (T = E = L = I = Q = 0; 0 < N.length;)
                ...
                m.replace("+", "").replace("-", "") : m.replace("-", ""), v += m.replace(/[0]+/, function(a) { return aa(X, a.length) }));
            w = "";
        ...
        Z = function(k) { for (var m = "", r = 0; r < k.length; r++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r)); return m },
    ...
    X.prototype.isBeingTracked = function(k) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[k] ? !0 : !1 };
    X.prototype.hasOptionChanged = function(k) { if (!this.sessionVariables) throw "Session Variable Store not set"; return this.sessionVariables[k] !== this.options[k] };
    ...
    X.prototype.removeEventListener = function(k, m) {
        if (k && m && this._eventListeners[k])
            for (var r = this._eventListeners[k], s = 0; s < r.length; s++)
                if (r[s].eventHandler === m) { r[s].splice(s, 1); break }
    };
    ...
    Ta.prototype.release = function(k) { this.pool.push(k) };
    oa(Ia, X);
    var Oa = { addTheme: function(k, m) { ab[k] = m }, addColorSet: function(k, m) { za[k] = m }, addCultureInfo: function(k, m) { Ja[k] = m }, formatNumber: function(k, m, s) { s = s || "en"; if (Ja[s]) return fa(k, m || "#,##0.##", new Ia(s)); throw "Unknown Culture Name"; }, formatDate: function(k, m, s) { s = s || "en"; if (Ja[s]) return Aa(k, m || "DD MMM YYYY", new Ia(s)); throw "Unknown Culture Name"; } };
    ...
    w = Oa.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), s ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = ta(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        ...
                        this.allDOMEventHandlers), W(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), W(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), W(this.overlaidCanvas, "mousedown", function(a) {
                        b._mouseEventHandler(a);
                        ua(b._dropdownMenu)
                    }, this.allDOMEventHandlers), W(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), W(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    W(this._zoomButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers);
                    ...
                    W(this._zoomButton, "mouseout", function() { d || (pa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && pa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) },
                        this.allDOMEventHandlers)
                }
        ...
        m.prototype.setLayout = function() {
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { s ? (this._breaksCanvas = ta(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break }
        ...
        m.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (c = 0; c < b.length; c++)
                if ("line" ===
                    ...
                    if (e = ma("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) { d = !0; break }
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (A = n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && A < Math.pow(n.dataInfo.minDiff,
                            3) || !n.logarithmic && A < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || g > n.maximum)) z.push(n), p.push({ val1: q, val2: g }), u = !0;
                    else if (!e) { u = !1; break }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== C && "" !== C) {
                    var t = ma("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        ...
                        v = !1,
                        g = new la(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: f ? 5 * z : 1.5 * z, angle: "horizontal" === x ? 0 : -90, text: C, padding: 0, backgroundColor: g, horizontalAlign: "left", fontSize: z, fontFamily: n, fontWeight: l, fontColor: u, fontStyle: q, textBaseline: "middle" });
                    g.measureText();
                    h.dataSeries.indexLabelMaxWidth = g.maxWidth;
                    if ("stackedarea100" === p) { if (h.point.x < c.x1 || h.point.x > c.x2 || h.point.y < c.y1 - 1 || h.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) { if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum) continue } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                    ...
                    } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !h.axisSwapped) { if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1) continue } else if (0 <= p.indexOf("bar") || "error" === p) { if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.bounds.x1 > c.x2 || h.bounds.x2 < c.x1) continue } else if ("candlestick" === p || "ohlc" === p) {
                        if (h.dataPoint.x <
        ...
        m.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var A = h.id;
                    this._eventManager.objectMap[A] = { objectType: "dataSeries", dataSeriesIndex: z };
                    A = S(A);
                    b.strokeStyle = A;
                        ...
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (x = p[t].x.getTime ? p[t].x.getTime() : p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                ...
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), J = !0;
                                    ...
                                    this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: t, x1: x, y1: r };
                                    ...
                                    if (0 < p[t].markerSize || 0 < h.markerSize) {
                                        ...
                                        f.push(y);
                                        B = S(B);
                                        s && f.push({ x: x, y: r, ctx: b, type: y.type, size: y.size, color: B, borderColor: B, borderThickness: y.borderThickness })
                                    }(p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: A })
                                }
                        c.stroke();
                        s && b.stroke()
                    }
                        ...
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (x = p[t].getTime ? p[t].x.getTime() :
                                ...
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), J = !0;
                                    ...
                                    if (0 < p[t].markerSize || 0 < h.markerSize) B = h.getMarkerProperties(t, x, r, c), f.push(B), y = S(y), s && f.push({ x: x, y: r, ctx: b, type: B.type, size: B.size, color: y, borderColor: y, borderThickness: B.borderThickness });
                            ...
                            if (t = p[m].getTime ? p[m].x.getTime() : p[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof p[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 <
                                    ...
                                    if (0 < p[m].markerSize || 0 < h.markerSize) {
                                        ...
                                        l.push(B);
                                        J = S(J);
                                        s && l.push({ x: t, y: x, ctx: e, type: B.type, size: B.size, color: J, borderColor: J, borderThickness: B.borderThickness })
                        ...
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < A.length; f++)
                            if (A[f].getTime ? z = A[f].x.getTime() : z = A[f].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof A[f].y) {
                                ...
                                (A[f].indexLabel || g.indexLabel || A[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    dataPoint: A[f],
                                    dataSeries: g,
                                    point: { x: l + (m - l) / 2, y: 0 > A[f].y === a.axisY.reversed ? u : t },
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: r, y1: n, x2: J, y2: B };
                                b = S(b);
                                ...
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    bounds: { x1: r, y1: Math.min(n, B), x2: J, y2: Math.max(n, B) },
                                    color: b
                                })
                            }
                    }
                    ...
                    if (0 < t.length)
                        for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: C, y1: n, x2: J, y2: B };
                                b = S(b);
                                s && da(this._eventManager.ghostCtx,
                                    C, n, J, B, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: t[h], dataSeries: m, point: { x: p, y: 0 <= t[h].y ? n : B }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: C, y1: Math.min(n, B), x2: J, y2: Math.max(n, B) }, color: b })
                            }
                }
                        ...
                        if (0 < A.length) {
                            ...
                            for (f = 0; f < A.length; f++)
                                if (A[f].getTime ? z = A[f].x.getTime() : z = A[f].x, !(z <
                                    ...
                                    (A[f].indexLabel || g.indexLabel || A[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: A[f], dataSeries: g, point: { x: 0 <= A[f].y ? l : t, y: u + (m - u) / 2 }, direction: 0 > A[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(t, l), y1: u, x2: Math.max(t, l), y2: m }, color: b })
                                }
                        }
                    }
                    s && (d.drawImage(this._preRenderCanvas,
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                b = m.dataPointIds[h];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: B, y1: C, x2: p, y2: J };
                                b = S(b);
                                s && da(this._eventManager.ghostCtx,
                                    B, C, p, J, b, 0, null, !1, !1, !1, !1);
                                (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? p : B, y: n }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(B, p), y1: C, x2: Math.max(B, p), y2: J }, color: b })
                            }
                    }
                }
                        ...
                        if (0 < t.length) {
                            ...
                            for (h = 0; h < t.length; h++)
                                if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? p : C, y: n }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(C, p), y1: J, x2: Math.max(C, p), y2: B }, color: b })
                                }
                        }
                    }
        ...
        m.prototype.renderArea = function(a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = C : 0 > a.axisY.viewportMaximum ? J = u.y1 : 0 < a.axisY.viewportMinimum && (J = C), f.lineTo(m, J), f.lineTo(B.x, J), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, s && (l.lineTo(m, J), l.lineTo(B.x, J), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m,
                    t), l.beginPath(), l.moveTo(m, t), B = { x: m, y: t })
            }
                            ...
                            if (r = A[k].x.getTime ?
                                ...
                                if ("number" !== typeof A[k].y) g.connectNullData || (ha || d) || b(), ha = !0;
                                    ...
                                    d || ha ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = p.x, t = p.y, b(), f.moveTo(p.x, p.y), m = d, t = c, B = p, c = g.nullDataLineDashType, f.setLineDash(K)), f.lineTo(m,
                                        t), s && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), s && (l.beginPath(), l.moveTo(m, t)), B = { x: m, y: t }), ha = d = !1) : (f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b());
                                    p = { x: m, y: t };
                                    ...
                                    0 !== A[k].markerSize && (0 < A[k].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(k, m, t, f), z.push(r), $ = S($), s && z.push({ x: m, y: t, ctx: l, type: r.type, size: r.size, color: $, borderColor: $, borderThickness: r.borderThickness }));
                                    (A[k].indexLabel || g.indexLabel || A[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: A[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > A[k].y === a.axisY.reversed ? 1 : -1, color: y })
                                }
                        b();
                        Y.drawMarkers(z)
                    }
                        ...
                        for (A = !1; q < n.length; q++)
                            if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !A)))
                                if ("number" !== typeof n[q].y) 0 < q && !A && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType ||
                                    ...
                                    this._eventManager.objectMap[K] = { id: K, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: q, x1: g, y1: A };
                                    r[r.length] = { x: g, y: A };
                                    ...
                                    if (0 !== n[q].markerSize && (0 < n[q].markerSize || 0 < p.markerSize)) {
                                        ...
                                        l.push(P);
                                        K = S(K);
                                        s && l.push({ x: g, y: A, ctx: e, type: P.type, size: P.size, color: K, borderColor: K, borderThickness: P.borderThickness })
        ...
        m.prototype.renderStepArea = function(a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = C : 0 > a.axisY.viewportMaximum ? J = u.y1 : 0 < a.axisY.viewportMinimum && (J = C), f.lineTo(m, J), f.lineTo(B.x, J), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha =
                    1, s && (l.lineTo(m, J), l.lineTo(B.x, J), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), B = { x: m, y: t })
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx,
                f = s ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (; k < A.length; k++)
                            if (r = A[k].x.getTime ? A[k].x.getTime() : A[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                ...
                                "number" !== typeof A[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), t = a.axisY.convertValueToPixel(A[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || K === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m,
                                    ...
                                    this._indexLabels.push({ chartType: "stepArea", dataPoint: A[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > A[k].y === a.axisY.reversed ? 1 : -1, color: y }))
                            }
                        b();
                        Y.drawMarkers(z)
                    }
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$)))
                                if ("number" !== typeof ia.y) y.connectNullData || ($ || x) || d(), $ = !0;
                                    ...
                                    x || $ ? (!x && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || C === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (x = h.pop(), C = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(C), h.push(x), C = y.nullDataLineDashType,
                                        b.setLineDash(P)), b.lineTo(g, k), s && r.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), s && (r.beginPath(), r.moveTo(g, k))), $ = x = !1) : (b.lineTo(g, k), s && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), s && r.moveTo(g, k), h.push({ x: g, y: m - na })));
                                    t = { x: g, y: k };
                                    q < v.length - 1 && (K !== (v[q].lineColor || w) || C !== (v[q].lineDashType || y.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({ x: g, y: m - na }), K = v[q].lineColor || w, b.strokeStyle = K, b.setLineDash && (v[q].lineDashType ? (C = v[q].lineDashType, b.setLineDash(Q(C, y.lineThickness))) : (C =
                                        y.lineDashType, b.setLineDash(D))));
                                    if (0 <= y.dataPointIndexes[f]) {
                                        var E = y.dataPointIds[y.dataPointIndexes[f]];
                                        this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: y.dataPointIndexes[f], x1: g, y1: k }
                                    }
                                    0 <= y.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < y.markerSize) && (na = y.getMarkerProperties(y.dataPointIndexes[f], g, k, b), l.push(na), f = S(E), s && l.push({ x: g, y: k, ctx: r, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness }));
                                    (ia.indexLabel ||
                                        y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: ia, dataSeries: y, point: { x: g, y: k }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, k);
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$)))
                                if ("number" !== typeof ia.y) y.connectNullData ||
                                    ...
                                    O || $ ? (!O && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || t === y.lineDashType &&
                                        y.lineDashType !== y.nullDataLineDashType) && (O = h.pop(), t = h[h.length - 1], d(), b.moveTo(r.x, r.y), h.push(t), h.push(O), t = y.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, m), s && C.lineTo(g, m)) : (b.beginPath(), b.moveTo(g, m), s && (C.beginPath(), C.moveTo(g, m))), $ = O = !1) : (b.lineTo(g, m), s && C.lineTo(g, m), 0 == q % 250 && (d(), b.moveTo(g, m), s && C.moveTo(g, m), h.push({ x: g, y: x - ca })));
                                    r = { x: g, y: m };
                                    ...
                                    if (0 <= y.dataPointIndexes[f]) {
                                        ...
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: y.dataPointIndexes[f], x1: g, y1: m }
                                    }
                                    0 <= y.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < y.markerSize) && (ca = y.getMarkerProperties(q, g, m, b), u.push(ca), f = S(F),
                                        s && u.push({ x: g, y: m, ctx: C, type: ca.type, size: ca.size, color: f, borderColor: f, borderThickness: ca.borderThickness }));
                    ...
                    if (p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                (q[e].indexLabel || n.indexLabel || q[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: n, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null })
                            }
                        ...
                        for (var C = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
                            if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] &&
                                ...
                                var v = k - m / 2 << 0,
                                    ...
                                    w = 0 === y % 2 ? 0 : 0.5,
                                    D = t.dataPointIds[u];
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: O, dataPointIndex: u, x1: v, y1: h, x2: B, y2: p, x3: k, y3: n, x4: k, y4: q, borderThickness: y, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = y;
                                ...
                                (x[u].indexLabel || t.indexLabel ||
                                    x[u].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: t.type, dataPoint: x[u], dataSeries: t, point: { x: v + (B - v) / 2, y: a.axisY.reversed ? n : p }, direction: 1, bounds: { x1: v, y1: Math.min(p, n), x2: B, y2: Math.max(p, n) }, color: e })
                            }
                }
                        ...
                        for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++)
                            if (C[l].getTime ? g = C[l].x.getTime() : g = C[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(C[l].y) && C[l].y.length && "number" === typeof C[l].y[0] && "number" === typeof C[l].y[1] && "number" === typeof C[l].y[2] && "number" === typeof C[l].y[3] && "number" === typeof C[l].y[4] && 5 === C[l].y.length) {
                                ...
                                (C[l].indexLabel || x.indexLabel || C[l].indexLabelFormatter ||
                                    x.indexLabelFormatter) && this._indexLabels.push({ chartType: x.type, dataPoint: C[l], dataSeries: x, point: { x: B + (y - B) / 2, y: a.axisY.reversed ? k : n }, direction: 1, bounds: { x1: B, y1: Math.min(k, n), x2: y, y2: Math.max(k, n) }, color: e })
                            }
                }
                s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                        ...
                        if (0 < B.length)
                            for (var E = v._colorSet, u = 0; u < B.length; u++) {
                                ...
                                if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !r(B[u].y) && B[u].y.length && "number" === typeof B[u].y[0] && "number" === typeof B[u].y[1]) {
                                    ...
                                    b && p > n && (ha = p, p = n, n = ha);
                                    ha = v.dataPointIds[u];
                                    this._eventManager.objectMap[ha] = { id: ha, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: u, x1: Math.min(p, n), y1: Math.min(q, g), x2: Math.max(n, p), y2: Math.max(g, q), isXYSwapped: b, stemProperties: P, whiskerProperties: K };
                                    w(c, Math.min(p, n),
                                        Math.min(q, g), Math.max(n, p), Math.max(g, q), e, K, P, b);
                                    s && w(this._eventManager.ghostCtx, p, q, n, g, e, K, P, b);
                                    if (B[u].indexLabel || v.indexLabel || B[u].indexLabelFormatter || v.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: B[u], dataSeries: v, indexKeyword: 0, point: { x: b ? B[u].y[1] >= B[u].y[0] ? p : n : p + (n - p) / 2, y: b ? q + (g - q) / 2 : B[u].y[1] >= B[u].y[0] ? g : q }, direction: B[u].y[1] >= B[u].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
                                        this._indexLabels.push({ chartType: "error", dataPoint: B[u], dataSeries: v, indexKeyword: 1, point: { x: b ? B[u].y[1] >= B[u].y[0] ? n : p : p + (n - p) / 2, y: b ? q + (g - q) / 2 : B[u].y[1] >= B[u].y[0] ? q : g }, direction: B[u].y[1] >= B[u].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b })
                                }
                            }
                    }
                    s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height),
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                                ...
                                if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: m[f], dataSeries: g, indexKeyword: 0, point: { x: m[f].y[1] >= m[f].y[0] ? l : u, y: k + (v - k) / 2 }, direction: m[f].y[1] >= m[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, u), y1: k, x2: Math.max(l, u), y2: v }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: m[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
                            ...
                            if (t = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K)))
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    q || K ? (p.connectNullData && !q ? (b.setLineDash && (p.options.nullDataLineDashType || y === p.lineDashType &&
                                        p.lineDashType !== p.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = E, y = p.nullDataLineDashType, b.setLineDash(D)), b.lineTo(m, r), s && e.lineTo(m, r), k.push({ x: m, y1: r, y2: v })) : (b.beginPath(), b.moveTo(m, r), x = { x: m, y: r }, k = [], k.push({ x: m, y1: r, y2: v }), s && (e.beginPath(), e.moveTo(m, r))), K = q = !1) : (b.lineTo(m, r), k.push({ x: m, y1: r, y2: v }), s && e.lineTo(m, r), 0 == g % 250 && d());
                                    t = p.dataPointIds[g];
                                    ...
                                    if (n[g].indexLabel || p.indexLabel || n[g].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 0, point: { x: m, y: r }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1, color: C }),
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 1, point: { x: m, y: v }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? 1 : -1, color: C })
                                } else K || q || d(), K = !0;
                        d();
                        Y.drawMarkers(f)
                    }
                        ...
                        for (g = !1; n < p.length; n++)
                            if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData ||
                                ...
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: n, x1: q, y1: g, y2: A };
                                    r[r.length] = { x: q, y: g };
                                    O[O.length] = { x: q, y: A };
                                    ...
                                    if (p[n].indexLabel || h.indexLabel || p[n].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: p[n].y[0] <= p[n].y[1] ? -1 : 1, color: t }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 1, point: { x: q, y: A }, direction: p[n].y[0] <= p[n].y[1] ? 1 : -1, color: t });
                                    g = !1
                    ...
                    if (0 < O.length)
                        for (var C = 5 < q && v.bevelEnabled ? !0 : !1, w = !1, B = null, y = null, l = 0; l < O.length; l++)
                            if (O[l].getTime ?
                                ...
                                (O[l].indexLabel || v.indexLabel || O[l].indexLabelFormatter || v.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: O[l], dataSeries: v, point: { x: k + (E - k) / 2, y: 0 <= O[l].y ? m : h }, direction: 0 > O[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: k, y1: Math.min(m, h), x2: E, y2: Math.max(m, h) }, color: e })
                            }
                }
                ...
                for (b = 0; b <
                    ...
                    if (d > c) {
                        var e = 0.07 * y * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (p[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (C.x + e)) || 1E-9 < Math.abs(g[b].center.y - (C.y + f))) g[b].center.x = C.x + e * a, g[b].center.y = C.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - C.x) || 0 < Math.abs(g[b].center.y - C.y)) g[b].center.x = C.x + e * (1 - a), g[b].center.y = C.y + f * (1 - a), l = !0;
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < p.length) {
                    ...
                    for (n = 1; n < p.length; n++)
                        if (l = (a - n + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) { l = null; break } else if (g[l].indexLabelText && g[l].hemisphere === g[a].hemisphere && l !== a && (0 > b(g[l], g[a]) || ("right" === g[a].hemisphere ? g[l].indexLabelTextBlock.y <=
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function b() {
                if (t && x) {
                    for (var a,
                            b, c, d, e, f, h, l, k, n, m, p, q, u, A = [], z = [], v = { percent: null, total: null }, C = null, y = 0; y < x.length; y++) u = R[y], u = "undefined" !== typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2, u = g(u).x2 + 1, A[y] = N - u - W;
                    u = 0.5 * W;
                    for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
                        ...
                        if (t.indexLabelFormatter || b.indexLabelFormatter) C = { chart: w.options, dataSeries: t, dataPoint: b, total: v.total, percent: v.percent };
                        ...
                        S.roundRect || Ba(S);
                        c = new la(S, { fontSize: f, fontFamily: l, fontColor: e, fontStyle: h, fontWeight: k, horizontalAlign: c, backgroundColor: d, maxWidth: q, maxHeight: !1 === z[y] ? p ? 4.28571429 * f : 1.5 * f : z[y], text: b, padding: ea });
                        c.measureText();
                        H.push({
                            textBlock: c,
                            id: t.reversed ? B : y,
            ...
            function k(a, b) { return (b < R.length ? H[b].textBlock.y : t.reversed ? U + D : sa + D) - (0 > a ? t.reversed ? sa - D : U - D : H[a].textBlock.y + H[a].height + ea) }

            function m(a, b, c) {
                var d, e, g, l = [],
                    k = D,
                    n = []; - 1 !== b && (0 <= Z.indexOf(b) ? (e = Z.indexOf(b), Z.splice(e, 1)) : (Z.push(b), Z = Z.sort(function(a, b) { return a - b })));
                if (0 === Z.length) l = ja;
                else {
            ...
            function n(a) { for (a -= 1; - 1 <= a && -1 != a && H[a].isDirty; a--); return a }

            function q(a) { for (a += 1; a <= R.length && a != R.length && H[a].isDirty; a++); return a }
            ...
            function v(a) {
                ...
                if (w.subtitles)
                    for (var b = 0; b < w.subtitles.length; b++) { var c = w.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) w.subtitles.ctx = a, c.render() }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== P) {
                        ...
                        if (K && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { l(); for (F = 0; F < x.length; F++) H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (N - a) / 2, 0 == F && (y = a), y > a && (y = a)); for (F = 0; F < R.length; F++) R[F].x1 += y, R[F].x2 += y, R[F].x3 += y, R[F].x4 += y, R[F].x5 && (R[F].x5 += y, R[F].x6 += y), H[F].textBlock.x += y }
                        ...
                        if (!K)
                            for (F = 0; F < x.length; F++) y = t.dataPointIds[F], a = { id: y, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[t.reversed ? x.length - 1 - F : F] }, w._eventManager.objectMap[y] = a;
                    ...
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var w = n.dataPoints[x],
                                ...
                                g = w.legendText ? w.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: w }) : w.name ? w.name : "DataPoint: " + (x + 1),
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            p = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: p, label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : fa(p, this.valueFormatString, this.chart._cultureInfo), a = new la(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 =
                            Math.round(f.x1 + R + M), d[g].lineCoordinates.x2 = Math.round(f.x2 - ba - aa > p.width - n ? p.width - n : f.x2 - ba - aa), d[g].lineCoordinates.width = Math.abs(m - l), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], k = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), t = k.textBlock.width * Math.cos(Math.PI / 180 *
                                ...
                                0)), d[g].bounds = { x1: l, y1: k + (Y + Z - w[g] - W), x2: m, y2: h, width: m - l, height: h - k }, W += w[g] + d[g].margin;
                    if (c && 0 < c.length)
        ...
        N.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, l = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: l, x2: f + d / 2, y2: k };
        ...
        ba.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y[b] }) : r(this.options.label) ? fa(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar" ===
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : r(this.options.label) ? fa(c ? c : x.dataPoint.y, this.valueFormatString,
                        ...
                        }) : r(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.x }) : r(this.options.label) ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (E) {
                        if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({ x: a }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label)
                    } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataPoint.x
                    }) : r(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                        ...
                        h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : E }) : r(this.options.label) ? fa(c ? c : E, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        this.value = E
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = k = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = l = m = 1 === q.lineWidth %
                    2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (E) {
                            if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({ y: d }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v =
                                    this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : r(this.options.label) ? v.dataPoint.label : this.label)
                    ...
                    if (E) {
                        if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({ x: a }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(a)
                ...
                } else if ("left" === this.parent._position || "right" === this.parent._position) h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : r(this.options.label) ? fa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, h.y = d + h.fontSize / 2 - h.measureText().height / 2 + 2, h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y =
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var l = this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h));
                                h = null
                            }
                        ...
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (l = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l,
                                    c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (l = this.chart.axisX2[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && k.push(h))
                    }
        ...
        aa.prototype.hide = function(a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) };
        aa.prototype.show = function(a, d, c) { this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c) };
        ...
        aa.prototype.getContainerTransition = function(a) { return "left " + a + "s ease-out 0s, bottom " + a + "s ease-out 0s" };
